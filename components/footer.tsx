...
export function Footer() {
  return (
    <motion.footer
      className="relative pt-16 pb-8 px-16 sm:px-30 lg:px-46 w-full overflow-hidden bg-[#151515]"
    ...
    >
      ...
      <div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#contact" className="text-muted-foreground hover:text-foreground text-sm font-sans transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-border/50">
          <p className="text-center text-muted-foreground/70 text-sm font-sans">

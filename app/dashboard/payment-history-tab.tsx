            ...
            <tbody>
              {payments.length === 0 ? (
                ...
                payments.map((payment, index) => (
                  ...
                  >
                    <td className="px-6 py-4 text-sm text-white/80">{payment.date}</td>
                    <td className="px-6 py-4 text-sm text-white/80">{payment.name}</td>
                    <td className="px-6 py-4 text-sm text-white/80">{payment.plan}</td>
                    <td className="px-6 py-4 text-sm text-white/80">{payment.fundraisers}</td>
                    <td className="px-6 py-4 text-sm text-white/80">{payment.amount}</td>
